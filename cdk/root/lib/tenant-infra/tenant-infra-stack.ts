  ...
  constructor(scope: Construct, id: string, props?: TenantInfraStackProps) {
    ...
    <br>`,
      ...
      customAttributes: {
        ...
        'plan': new cognito.StringAttribute({ mutable: false }),
        'api-key': new cognito.StringAttribute({ mutable: false}),
        'path': new cognito.StringAttribute({ mutable: false}),
    ...
    this.pooledTenantUserPoolArn = pooledTenantPool.userPoolArn;
