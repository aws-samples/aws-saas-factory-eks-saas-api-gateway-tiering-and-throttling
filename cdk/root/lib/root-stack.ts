...
import { TenantInfraStack } from './tenant-infra/tenant-infra-stack';
import getTimeString from './utils';
import { CdkApigatewayTsStack } from './apigateway-stack/apigateway-stack';
...
export class RootStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const apigatewayStack = new CdkApigatewayTsStack(this, 'apigatewayStack', {
      pooledTenantUserPoolArn: tenantInfra.pooledTenantUserPoolArn,
      elbUrl: eksElbUrl.valueAsString,
    })
    ...
    new CfnOutput(this, 'ApiURL', { value: apigatewayStack.apiGatewayUrl });
    new CfnOutput(this, 'restApiId', { value: apigatewayStack.restApi.restApiId });
    new CfnOutput(this, 'BasicUsagePlanId', { value: apigatewayStack.basicUsagePlan.usagePlanId });
    new CfnOutput(this, 'StandardUsagePlanId', { value: apigatewayStack.standardUsagePlan.usagePlanId });
    new CfnOutput(this, 'PremiumUsagePlanId', { value: apigatewayStack.premimumUsagePlan.usagePlanId });
